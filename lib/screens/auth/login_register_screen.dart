...
class LoginRegisterScreen extends StatefulWidget {
  ...
  const LoginRegisterScreen({Key? key, this.callBack}) : super(key: key);
...
class _LoginRegisterState extends State<LoginRegisterScreen> with TickerProviderStateMixin {
